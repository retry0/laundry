                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-header">
                             <small><font color='green'>Menampilkan Pelanggan perbulan</font></small>
                        </h2>
                    </div>
                </div> 
                <!-- /. ROW  -->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
							 <div class="panel-heading">
                                 <?php echo anchor('pelanggan/cetak_laporan_pelanggan','Cetak',array('class'=>'btn btn-success btn-sm')) ?>
                            </div>
                                <?php echo form_open('pelanggan/tampil_laporan_pelanggan', array('class'=>'form-inline')); ?>

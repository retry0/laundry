                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?php echo form_open('pesanan_pelanggan', array('class'=>'form-horizontal')); ?>
								<div class="form-group">
                                        <label class="col-sm-2 control-label">No Nota</label>
                                        <div class="col-sm-10">
                                          <input list="text" name="no_nota" class="form-control"  readOnly value="<?php echo $no_nota; ?>" required >
										   </div>
										    </div>
								<div class="form-group">
							 ...
							 <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                          <input type="hidden" name="nama_cabang"  value="Transaksi Online" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <?php $no=1; $kembalian=0; $total=0;    foreach ($detail as $r){ ?>
                                            <tr class="gradeU">
												...
												<td >
                                                    <a onclick = "return hapusBarang()" <?php echo anchor('pesanan_pelanggan/hapusitem/'.$r->p_detail_id,'Delete',array('class'=>'btn btn-danger btn-sm')); ?>
